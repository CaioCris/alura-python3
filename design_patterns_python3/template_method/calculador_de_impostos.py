from design_patterns_python3.template_method.impostos import ISS, ICMS, ICPP, IKCV
...
if __name__ == '__main__':
    from design_patterns_python3.template_method.orcamento import Orcamento, Item

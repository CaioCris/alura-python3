...
from design_patterns_python3.builder.nota_fiscal import NotaFiscal


class CriadoNotaFiscal:
    ...
    def construir(self):
        if self.__razao_social is None:
            raise Exception('Razao social deve ser preenchido')
        ...
        elif self.__data_de_emissao is None:
            self.__data_de_emissao = date.today()
        elif self.__detalhes is None:
            self.__detalhes = ''
